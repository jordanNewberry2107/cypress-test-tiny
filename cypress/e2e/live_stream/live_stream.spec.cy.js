...
describe('Live Streams', () => {
  ...
  context('Perform Actions on a Live Stream', () => {
    it('Creates a new live stream', () => {
      ...
      LiveStreamPage.enterStreamDetails(currentTime, 'Test Stream', 'Test Opponent')
      LiveStreamPage.selectAndroidStreamingDevice()
      LiveStreamPage.clickNextButton()
    ...
    it('Deletes the live stream and logs out', () => {
      ...
      cy.get('h3').should('be.visible').and('have.text', 'Scheduled Streams (0)')
